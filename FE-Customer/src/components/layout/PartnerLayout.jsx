...
function isChildActive(pathname, childHref) {
  ...
  if (childHref === '/partner/company') {
    return pathname === '/partner/company' || pathname.startsWith('/partner/company/')
  }
...
export function PartnerLayout() {
  ...
  useEffect(() => {
    ...
    // Đồng bộ accordion theo route — defer để tránh setState đồng bộ trong effect (eslint)
    if (!section) return
    const id = section.id
    queueMicrotask(() => setOpenId(id))
  }, [pathname])
