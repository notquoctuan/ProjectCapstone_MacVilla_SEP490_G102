    ...
    <section className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm sticky top-24">
      ...
      <div className="mt-6">
        <div className="flex gap-2 mb-4">
          ...
          <button
            type="button"
            className="px-4 py-2 bg-slate-800 dark:bg-slate-700 text-white text-sm font-bold rounded-lg hover:bg-slate-900 dark:hover:bg-slate-600 transition-colors"
          >
            Áp dụng
          </button>
        </div>
        <button
          ...
          className="w-full py-4 bg-primary text-white rounded-xl font-black text-lg shadow-lg shadow-primary/30 hover:bg-primary/90 transition-all transform hover:-translate-y-0.5 uppercase tracking-wide"
        >
          Đặt hàng ngay
        </button>
