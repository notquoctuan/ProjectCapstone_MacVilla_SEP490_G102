...
const CLAIM = (id) => `/admin/after-sales/warranty/claims/${encodeURIComponent(String(id))}`;
...
export function AdminWarrantyTicketDetailPage() {
              ...
              <CardContent className="space-y-3 text-sm">
                ...
                <div className="flex justify-between gap-4">
                  ...
                  <span className="text-right">
                    {oid != null ? (
                      <Link className="font-mono text-violet-700 hover:underline dark:text-violet-400" to={`/admin/sales/orders/${encodeURIComponent(String(oid))}`}>
                        #{oid}
                      </Link>
                    ) : (
                      "—"
