...
export function ManagerWarrantyClaimDetailPage() {
                ...
                {claimTerminal ? (
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-semibold uppercase text-slate-500" htmlFor="mgr-claim-next-st">
                        Chuyển sang <span className="text-red-600">*</span>
                      </label>
                      <select
                        id="mgr-claim-next-st"
