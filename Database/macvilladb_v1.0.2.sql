...
INSERT INTO `cart_items` VALUES (1,1,1,2,'2026-03-06 00:47:08');
...
INSERT INTO `carts` VALUES (1,1,'2026-03-06 00:47:08','2026-03-06 00:47:08'),(2,7,'2026-03-05 18:43:53','2026-03-05 18:43:53');
...
INSERT INTO `employees` VALUES (1,1,'Tổng quản lý'),(2,3,'Quản lý kho vận'),(3,4,'Nhân viên nội bộ'),(4,5,'Nhân viên nội bộ'),(5,6,'Tổng quản lý');
...
CREATE TABLE `orders` (
  ...
  KEY `fk_orders_shipping_method` (`shipping_method_id`),
  CONSTRAINT `fk_orders_shipping_address` FOREIGN KEY (`shipping_address_id`) REFERENCES `shipping_address` (`shipping_address_id`),
  CONSTRAINT `fk_orders_shipping_method` FOREIGN KEY (`shipping_method_id`) REFERENCES `shipping_methods` (`shipping_method_id`),
...
INSERT INTO `product_images` VALUES (1,NULL,'img/bosch_pid675.jpg',1),(2,NULL,'img/eurosun_t210.jpg',1),(3,NULL,'img/canzy_350c.jpg',1),(4,NULL,'/uploads/products/d884feb3-b95b-4717-8bac-26e955ea836e_Logo-13.png',1),(5,NULL,'/uploads/products/7d7f8d52-7918-4df5-a7c2-2a8d365cbddc_logo-fpt-34.jpg',1),(6,NULL,'/uploads/products/a3b6e5d3-f7b5-4788-a306-68044914d877_Screenshot 2026-02-05 140931.png',1),(7,NULL,'/uploads/products/742c994c-9b4f-4715-9bf7-0fd0c94b2ab4.jpg',1),(8,NULL,'/uploads/products/005f65d7-3d26-4531-8b68-e60002f8a49f_IMGL5586.JPG',1),(9,2,'/uploads/products/a2b8ad3a-7f99-477a-bb2d-42067d19b769_IMGS9325.jpg',1),(10,3,'/uploads/products/73b03a61-bfca-4f53-89b6-e8b1ed28c9a4_IMGS9367.jpg',1),(11,4,'/uploads/products/68c11a40-fafc-44c9-b3a2-e92aceb76ef6_IMGS9367.jpg',1),(12,NULL,'/uploads/products/caa2c2eb-177d-4054-a530-8a43d7566f53_IMGS9341.jpg',1),(13,NULL,'/uploads/products/a0224ed9-9be1-42d0-8b73-6304fcc52f62_IMGS9369.jpg',1),(14,NULL,'/uploads/products/ab83de00-bbcd-4d65-84df-5c2b81280845_IMGL9264.JPG',1),(15,NULL,'/uploads/products/905ad1b7-cf24-49eb-916a-2eeaa2fbe3e9_IMGS9361.jpg',1),(16,NULL,'/uploads/products/f6acfdaa-fd47-428e-8a8b-6f4d3a5fb7ce_IMGS9367.jpg',1),(17,NULL,'/uploads/products/c919fbdf-12b7-46f8-ae52-95b1772cc7b0_IMGL9264.JPG',1),(18,NULL,'/uploads/products/bb9a3b3f-d2b2-47b3-b018-9e4748b73bea_IMGS9304.jpg',1),(19,1,'/uploads/products/50aa1012-334a-4c3c-af2e-0d2752d05d31_IMGS9294.jpg',1),(20,8,'/uploads/products/a2951c47-37b2-45d1-bf63-246cc8a7fa6d_IMGS9336.jpg',1),(21,7,'/uploads/products/29b4f3fa-3597-4131-989c-c727f1045355_IMGS9352.jpg',1),(22,5,'/uploads/products/f21a529c-7c59-4e6c-b0b6-2e95bdbb319c_IMGS9369.jpg',1),(23,9,'/uploads/products/27ee88a4-035e-4ee3-8ae5-578f777a8ca4.jpg',1),(24,10,'/uploads/products/dd61d038-09a3-4d20-8fbe-a7099a104a93.jpg',1),(25,10,'/uploads/products/51bcfb72-557a-46b2-835e-af502963a96f.jpg',0),(26,10,'/uploads/products/8089a923-5084-458f-8faf-7b44c2517cf8.jpg',0),(27,10,'/uploads/products/f75a77f2-e066-427b-b3b2-f07a038845b7.jpg',0),(28,6,'/uploads/products/ecf68d8a-c337-42f7-97f6-4256ba4cd569_IMGL5586.JPG',1);
...
INSERT INTO `products` VALUES (1,57,'Bếp từ Bosch PID675DC1E','Bếp từ 3 vùng nấu, seri 8 cao cấp',1.00,'Disable','2026-01-29 22:34:45'),(2,1,'duc123','Bếp từ đôi, công nghệ Inverter tiết kiệm điện',100.00,'Enable','2026-01-29 22:34:45'),(3,98,'Hút mùi kính cong Canzy CZ-350C','Kính cong sang trọng, lực hút mạnh',3200000.00,'Enable','2026-01-29 22:34:45'),(4,107,'Chậu rửa bát 1 hố Nano','Inox 304 phủ Nano chống bám bẩn',2500000.00,'Enable','2026-01-29 22:34:45'),(5,47,'Máy lọc nước Karofi Optimus S345','Hệ thống 9 lõi lọc tiêu chuẩn',6500000.00,'Disable','2026-01-29 22:34:45'),(6,3,'Bếp từ Bosch Serial 8',NULL,1.00,'Pending','2026-02-07 03:24:41'),(7,2,'abc','duchahaha',1.00,'Enable','2026-02-07 03:40:07'),(8,57,'adsadadadad','okok',3.00,'Pending','2026-02-07 06:59:53'),(9,57,'Bếp từ ','Đây là bếp từ',2000.00,'Disable','2026-02-08 00:58:57'),(10,10,'Máy rửa bát AAAA','đây là máy rửa bát',3.00,'Disable','2026-02-08 01:21:48');
...
INSERT INTO `user_credentials` VALUES (1,1,'$2a$11$ZzrpMygWbC6ZGCwE7ySaY.p5woYKMr6i.UHlBRYf77iadjNIxSQXe','2026-01-29 22:35:31'),(2,2,'hash_customer_123','2026-01-29 22:35:31'),(3,3,'hash_warehouse_123','2026-01-29 22:35:31'),(4,4,'$2a$11$MaGkcvH11406PZDdy9sf8ezZHoZWRAXDHD5Cfr/p.JozZZ1Use9WW','2026-03-03 02:54:17'),(5,5,'$2a$11$MCqpTI2GXmeSvCzH5gtRV.L9DsOl0.SqKkk7FA0GcRjvFWHGAcAFe','2026-03-03 03:07:31'),(6,6,'$2a$11$oldmduQsMoGBsUKB1cOtdeXFR46vkWKP4ErFV1r0.w4FP5enjZwJG','2026-03-03 16:43:03'),(7,7,'$2a$11$m2J4OfR2DZQvpG7ikiaBvOlvTIxiCEOGcKUf.DmjKRe2OXw65HNtW','2026-03-05 18:43:08');
...
INSERT INTO `users` VALUES (1,'admin@macvilla.vn','Nguyễn Quản Trị',NULL,NULL,'Admin','Active','2026-01-29 22:35:31'),(2,'customer@gmail.com','Trần Khách Hàng',NULL,NULL,'Customer','Active','2026-01-29 22:35:31'),(3,'warehouse@macvilla.vn','Lê Thủ Kho',NULL,NULL,'Employee','Active','2026-01-29 22:35:31'),(4,'string','string',NULL,NULL,'string','Active','2026-03-03 02:54:16'),(5,'string1','string1',NULL,NULL,'string1','Active','2026-03-03 03:07:30'),(6,'admin1231@gmail.com','duc',NULL,NULL,'Admin','Active','2026-03-03 16:43:03'),(7,'admin@gmail.com','Nguyen Anh Duc',NULL,NULL,'Admin','Active','2026-03-05 18:43:07');
...
-- Dump completed on 2026-03-07 22:40:34
